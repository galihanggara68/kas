...
class TransactionController extends Controller
{
    ...
    public function index($transaction_type)
    {
        ...
        return view('admin.transaction.index',compact(['data','transaction_type']));
    }
    ...
    {
        return view('admin.transaction.create',compact(['transaction_type']));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.transaction.show',compact(['data','transactionCharge','currency']));
    ...
    public function printJobSheet($id){
        ...
        // return view('admin.transaction.job-sheet',compact(['data']));
        $pdf = PDF::loadView('admin.transaction.job-sheet',compact(['data','container','charge']));
    ...
    public function printDeliveryOrder($id){
        $data = $this->transaction->find($id);
        $container = $this->transactionContainer->where('transaction_id',$data->id)->get();
        // return view('admin.transaction.delivery-order',compact(['data']));
        $pdf = PDF::loadView('admin.transaction.delivery-order',compact(['data','container']));
    ...
    public function printInvoice($id){
        ...
        $container = $this->transactionContainer->where('transaction_id',$data->id)->get();
        $charge = $this->transactionCharge->where('transaction_id',$data->id)->get();
        // return view('admin.transaction.invoice',compact(['data','container','charge']));
        $pdf = PDF::loadView('admin.transaction.invoice',compact(['data','container','charge']));
    ...
    public function editCharge($id,$charge_id){
        ...
        return view('admin.transaction.editCharge',compact(['charge','data','transactionCharge','currency']));
    }
